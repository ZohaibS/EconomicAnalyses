...
function drawChart() {
        ...
        data.addRows([
          ...
          [ 'Received Low Level of Aid', 'Medium Developed Nation', 36 ],
          [ 'Received Low Level of Aid', 'High Developed Nation', 4 ],
          [ 'Received Medium Level of Aid', 'Low Developed Nation', 7 ],
          [ 'Received Medium Level of Aid', 'Medium Developed Nation', 35 ],
          [ 'Received Medium Level of Aid', 'High Developed Nation', 1 ],
          [ 'Received High Level of Aid', 'Low Developed Nation', 15],
          [ 'Received High Level of Aid', 'Medium Developed Nation', 25]
        ]);
  ...
  'cyan', 'teal'];
        ...
        var chart = new google.visualization.Sankey(document.getElementById('sankey_basic_1'));
